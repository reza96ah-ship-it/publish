...
.dark { /* dark variants — deeper canvas, brighter accent */ }
```
...
*End of design system. Component-level API docs live with each component in code; this
document is the contract they conform to.*
