...
- **P2 MUST** stories make it a _team_ tool (inbox, approvals, automation, AI, RBAC).
...
_End of backlog. Each story will carry a dedicated task in the project tracker with
linked PRs, E2E specs, and design links once execution begins._
