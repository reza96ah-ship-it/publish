/**
 * Issue #253: Competitor share-of-voice API.
 *
 *   GET /api/competitors/share-of-voice?days=30   — mention + engagement share
 *
...
export async function GET(req: NextRequest) {
  ...
  try {
    const result = await competitorsService.getShareOfVoice(
