...
/**
 * GET /api/inbox/threads/[id]/context — customer context for the panel:
 * how long we've known this sender + their other conversations here.
 */
export async function GET(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    const result = await inboxService.getThreadCustomerContext(
