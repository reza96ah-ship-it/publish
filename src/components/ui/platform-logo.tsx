...
export function InstagramLogo({ className, style }: LogoProps) {
  return (
    <ImgLogo
      src={META.instagram.src}
      alt="Instagram"
      className={className}
      rounded={META.instagram.rounded}
      style={style}
    />
  )
}
export function TelegramLogo({ className, style }: LogoProps) {
  return (
    <ImgLogo
      src={META.telegram.src}
      alt="Telegram"
      className={className}
      rounded={META.telegram.rounded}
      style={style}
    />
  )
}
export function LinkedInLogo({ className, style }: LogoProps) {
  return (
    <ImgLogo
      src={META.linkedin.src}
      alt="LinkedIn"
      className={className}
      rounded={META.linkedin.rounded}
      style={style}
    />
  )
}
