...
export function Sidebar() {
  ...
  return (
    <aside
      className="n-glass-nav flex h-full w-[260px] flex-col overflow-hidden rounded-none border-x border-t border-b-0"
    >
      {/* Brand Header */}
      <div className="flex items-center gap-2.5 px-4 pt-4 pb-3">
        ...
        <div className="flex flex-col leading-tight">
          ...
          <span className="text-[9.5px] font-[600] text-ink-tertiary tracking-[0.1em]">NASHRINO</span>
        </div>
        <button
      ...
      <nav className="flex-1 overflow-y-auto no-scrollbar px-2 py-1 space-y-px">
        <p className="px-2.5 pb-1 pt-2 text-[9.5px] font-[600] uppercase tracking-[0.1em] text-ink-tertiary">منوی اصلی</p>
        ...
        <p className="px-2.5 pb-1 pt-3 text-[9.5px] font-[600] uppercase tracking-[0.1em] text-ink-tertiary">مدیریت</p>
      ...
      <div className="mt-auto border-t border-border/60 px-2 py-2 space-y-px">
        ...
        <button className="flex w-full items-center gap-2.5 rounded-md px-2.5 py-2 text-right transition-colors hover:bg-surface-hover/70">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[12px] font-[600] text-ink-primary truncate leading-tight">برند آرامش</p>
        ...
        <div className="flex items-center gap-2.5 px-2.5 py-2 rounded-md hover:bg-surface-hover/70 transition-colors cursor-pointer">
          ...
          />
          <div className="flex-1 min-w-0">
            <p className="text-[12px] font-[600] text-ink-primary truncate leading-tight">علی احمدی</p>
            <p className="text-[10px] font-[500] text-ink-tertiary truncate leading-tight">مدیر عملیات</p>
          </div>
          <button aria-label="خروج" className="p-1 rounded-md text-ink-tertiary hover:text-danger hover:bg-danger-soft transition-colors">
